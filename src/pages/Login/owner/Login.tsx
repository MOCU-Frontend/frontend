      ...
      <main className={styles.mainSect}>
        <div className={styles.mainBorderWrapper}>
          ...
          <Link
            ...
            to={`https://kauth.kakao.com/oauth/authorize?client_id=${process.env.REACT_APP_KAKAO_CLIENT_ID}&redirect_uri=${'http://192.168.86.180:3000/login/owner/oauth'}&response_type=code`}
          >
            <KakaoLoginBtnIcon />
          </Link>
        </div>
